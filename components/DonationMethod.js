      ...
      fields: [
        {
          ...
          value: "2223330000456987",
          isTracking: true,
        },
        {
          label: "Beneficiary Name",
          value: "Wesley College Old Students Association",
        },
      ...
      <div className="lg:col-span-2 space-y-8">
          ...
          {tabs.map((tab) => (
            <a
              ...
              className={`py-4 text-xs md:text-sm font-semibold transition-all relative whitespace-nowrap ${
                activeTab === tab.id
                  ? "text-[#2C6700]"
                  : "text-[#667085] hover:text-slate-600"
              }`}
            >
              {tab.label}
              {activeTab === tab.id && (
        ...
        <section id="about" className="scroll-mt-24 bg-white p-6">
          ...
          <p className="text-sm text-[#667085] leading-relaxed">
            Wesley College of Science (founded as Wesley College on November 5,
            1905) is a government controlled, co-educational, senior secondary
            school located in Ibadan, Oyo State.
          </p>
        </section>
